...
| Item | Answer |
|---|---|
| OJ problem number/title |[LEARNING LOGS] SurprisingVote (3024)|
...
| I used AI as a coach, reviewer, debugger, or test-case helper, not as a full-answer generator. |Yes| Briefly explain : ช่วยให้ AI อธิบายวิธีการหา mid กับ minimum|
...
```text
ใช้ AI ในการหา bug ใน Code แล้วก็หาแนวทางในการแก้
```
...
```text
AI ช่วยทำให้เห็นว่า Code original ที่เขียนมามันรับมาได้แต่เลขจำนวนเต็ม ถ้าเป็นเลขทศนิยมจะผิด
```
...
```text
เทส Code ใน VS code
เช็ค expect output กับ actual output
```
...
```text
AI ทำให้เห็นว่าภาษาสำคัญแค่ไหน แค่คำว่า ห่างกันเกิน ถ้าเข้าใจผิดเขียนเป็น >= 2 ก็สามารถทำให้โค้ดผิดได้และยังทำให้ได้รู้วิธีการหาค่ากลางกับค่าต่ำสุดด้วย
```
