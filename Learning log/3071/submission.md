...
```text
โจทย์ให้รับค่าจำนวนเต็ม A B d r แล้วให้หาว่าในช่วงของ A กับ B มีเลขไหนบ้างที่หาร d แล้วได้เศษ r บ้าง
Input:
โปรแกรมรับจำนวนเต็ม A B d r

Output:
โปรแกรมควรพิมพ์จำนวนเลขในช่วง A B ที่หาร d แล้วได้เศษ r ทั้งหมด

Constraints:
input บอกว่าเป็นช่วง ฉันควรพิจารณาการเขียน loop ให้ทำงานเร็วกว่า Time Limit เพราะถ้าทำงานช้าเกินไปจะไม่ผ่าน
```
...
```text
Step 1: รับค่า A B d r
Step 2: เขียน list มาเก็บคำตอบ
Step 3: เขียน for loop โดยให้ range เป็น(A,B+1) เพื่่อให้เริ่มที่ A และจบที่ B พอดี
Step 4: เขียน if statement ว่าถ้าตัวเลขนั้นหาร d ลงตัวแล้วได้เศษ r ให้เอาตัวเลขนั้นไปใส่ในลิสคำตอบ
Step 5:print คำตอบออกมาโดยใช้ len() เพื่อนับว่าใน list มีกี่ตัว
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ % ในการหาว่าตัวเลขที่อยู่ในช่วง a b มีตัวไหนบ้างที่หาร d แล้วเศษจะได้ r
 และ print คำตอบสุดท้ายออกมาโดยการใช้ len()
```
...
```text
ทดสอบไม่มีตัวไหนในช่วงที่หารได้ r
```
