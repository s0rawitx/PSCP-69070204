...
```text
โจทย์ให้หาว่าระหว่างโหวตที่มากที่สุดและน้อยที่สุดห่างกันเกิน 2 คะแนนไหม

Input:
โปรแกรมรับจำนวนของจำนวนโหวตทั้งหมด และจำนวนโหวตที่มากที่สุด

Output:
โปรแกรมควรพิมพ์ "Surprising" ถ้า โหวตมากสุดและน้อยสุดห่างกันเกิน 2 แต่ถ้าไม่ให้พิมพ์ "Not surprising"

Constraints:
input เป็นที่โจทย์บอกมาแค่คะแนนโหวต ฉันควรพิจารณาว่าโหวตอาจเป็นเลขทศนิยมได้
```
...
```text
Step 1:รับ input คะแนนโหวตทั้งหมด และ คะแนนโหวตที่มากที่สุด
Step 2:หาว่าโหวตที่เหลือที่ไม่รวมคะแนนสูงสุดคือเท่าไหร่
Step 3:เอาคะแนนโหวตที่เหลือไปหาร 2 แบบไม่เอาเศษเพื่อหาคะแนนน้อยสุด
Step 4:เขียน if statement เพื่อบอกว่าถ้าคะแนนโหวตสูงสุดมากกว่าน้อยสุดเกิน 2 ให้ print ตามที่โจทย์บอก
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่เปลี่ยน Step 3 โดยเปลี่ยนจากหารปัดเศษทิ้งให้กลายเป็นการหาค่าตรงกลางที่มากที่สุดเพื่อเอามาลบกับคะแนนที่เหลทอเพื่อหาค่าน้อยสุดแทน
```
