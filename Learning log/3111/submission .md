...
```text
โจทย์ให้คำนวณราคาขนมและเครื่องดื่มที่นักเรียนซื้อ

Input:
โปรแกรมรับค่าสถานะสมาชิก จำนวนสินค้า และราคาสินค้า

Output:
โปรแกรมควรพิมพ์ราคาสุทธิหลังจากลดราคาแล้ว

Constraints:
input มีหลายอัน ควรใช้ loop ในการรับค่า input
```
...
```text
Step 1: รับค่าสถานะ,จำนวนสินค้าและเขียนตัวแปร total มารับราคาสินค้าทั้งหมด
Step 2: เขียน for loop ให้ใส่ input ตามจำนวนสินค้า และบวกราคาสินค้าเข้า total
Step 3: เขียน if statement ถ้าเป็นสมาชิกลด 5% ถ้าไม่แต่ราคาสินค้าทั้งหมดมากกว่า 500 ลด 3% ถ้าไม้ใช่ทั้งสองก็ราคาเท่าเดิม
Step 4: print ราคาสุทธิแบบทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรกแต่เพิ่มการปัดทศนิยมของคำตอบขึ้น โดยใช้ import decimal เพราะถ้าใช้ round มันปัดไปปที่เลขคู่ใกล้สุดทำให้คำตอบไม่เหมือน testcase
```
