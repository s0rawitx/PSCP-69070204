...
```text
โจทย์ให้คำนวณราคาค่าส่งของสินค้า

Input:
โปรแกรมรับจำนวนต้นทางกับปลายทางและน้ำหนักพัสดุ

Output:
โปรแกรมควรพิมพ์ ผลราคาการนําส่งพัสดุที่ได้จากข้อมูลนําเข้าและ Error ถ้าหากเส้นทางที่ระบุไม่อยู่ในตาราง

Constraints:
input ต้นทางและปลายเป็นบรรทัดเดียวกัน ควรจะแยกระหว่างปลายทางและต้นทาง
```
...
```text
Step 1: อ่านต้นทางและปลายทาง 
Step 2: เขียน dict ราคาเริ่มต้นของแต่ละอัน
Step 3: เขียน dict เรทราคาน้ำหนักแต่ละอัน
Step 4:เขียนสูตรคำนวณราคาสุดท้ายโดยใช้ key ของ dict ราคาเริ่มต้นและ key ของเรทราคาน้ำหนักที่คูณกับน้ำหนัก บวกกัน
Step 5:print คำตอบออกมาแบบทศนิยม 2 ตัว
Step 6: เขียน condition ว่าถ้าต้นทางหรือปลายทางไม่อยู่ใน dict 
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ try except เพื่อดัก case ที่ต้นทางหรือปลายทางไม่อยู่ใน dict เพราะถ้าต้นทางหรือปลายไม่อยู่ใน dict จะเกิด keyerror เลยใช้ try execpt เพื่อพิมพ์ error ออกมา
```
