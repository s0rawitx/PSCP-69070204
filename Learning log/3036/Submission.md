...
```text
โจทย์ให้หาว่าห้องที่ input มาจะไปสู่ห้องที่ 1 แบบเจาะกำแพงน้อยที่สุดจะต้องเจาะกี่กำแพง

Input:
โปรแกรมรับห้องที่อยู่มา(เป็นจำนวนเต็ม)

Output:
โปรแกรมควรพิมพ์ จำนวนเลขที่ต้องเจาะ

Constraints:
input ที่โจทย์ให้มามีตั้งแต่ 1 - 100,000 ฉันควรพิจารณาเวลาที่ code ใช้เวลา run เพราะ ถ้า code run เกิน  1 วิจะไม่ผ่าน
```
...
1.รับ input มาก่อน
2.หาว่า input ที่รับมาอยู่แถวไหน
3.หาว่าเลขสุดท้ายของแถวนั้นคือเลขอะไร
4.เขียน if statement หาว่าเลขที่รับมาเป็นสามเหลี่ยมหงายหรือคว่ำโดยการนำแถวหาว่าเป็นเลขคู่หรือคี่ ถ้าเป็นคู่จะเป็นสามเหลี่ยมหงายและเลขคี่จะเป็นสามเหลี่ยมคว่ำ ถ้าเป็นหงายจะเดินมากกว่าคว่ำ และเขียนสูตรคำนวณหากำแพงที่ต้องเจาะ โดยหงาย = (2 x Row) -2 และ คว่ำ = (2 x Row) - 3 และเขียนดักกรณีที่เป็น 1 ให้ print 0
```
