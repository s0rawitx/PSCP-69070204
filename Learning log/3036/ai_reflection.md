...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3036 - ปราสาท |
| OJ submission ID, if submitted | 558645 |
| OJ status | Pass |
...
| I used `instructions/COURSE_AI_INSTRUCTIONS.md`, `instructions/AGENTS.md`, or manually followed the course AI instructions if the tool did not support custom instructions. | Yes |ให้ AI ช่วยอธิบายปัญหาให้เข้าใจได้มากขึ้นและช่วยให้ชี้ให้เห็นความสัมพันธ์ระหว่างแถวและสูตรการคำนวณ|
...
| I used AI as a coach, reviewer, debugger, or test-case helper, not as a full-answer generator. | Yes |เขียนโค้ดมาแล้ว แต่รันแล้วคำตอบยังผิดอยู่เลยให้มันช่วยดูว่าตรงไหนผิด|
...
```text
1.ให้ AI ช่วยอธิบายโจทย์ให้เข้าใจได้มากขึ้น
2.ช่วยให้ AI ชี้ให้เห็นความสัมพันธ์ระหว่าง row
3.ช่วยให้ AI คิดสูตรในการคำนวณหาช่องเดิน
4.ช่วยให้ AI debug โค้ดให้
```
...
```text
AI ช่วยให้ฉันเห็นว่าถ้าใส่วงเล็บในการคูณผิดคำตอบก็จะผิด
```
...
```text
ฉันเขียน code เองและนำคำอธิบายของ AI มาแปลเป็นภาษาของตัวเอง
...
```text
ฉันได้เรียนรู้วิธีแก้ปัญหาโดยใช้ความสัมพันธ์ทางคณิตศาสตร์และทำให้เห็นถึงความสำคัญของวงเล็บเวลาคูณเลขหรือหารเลขโดยใช้ python
```
