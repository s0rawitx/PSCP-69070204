...
```text
โจทย์ให้แปลงอุณหภูมิเป็นหน่วยต่างๆตามที่โจทย์กำหนด

Input:
โปรแกรมรับจำนวนจริง,หน่วยแรกและหน่วยที่จะให้แปลงเป็น

Output:
โปรแกรมควรพิมพ์อุณหภูมิตามที่แปลงได้

Constraints:
input มี String ฉันควรพิจารณา พิมพ์ใหญ่ พิมพ์เล็ก เพราะสามารถพิมพ์ได้ทั้ง 2 อย่าง
```
...
Step 2:เขียน if statement ให้แต่ละหน่วยอุณภูมิ
Step 3:print ผลลัพธ์ออกมาแบบทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ if ในการเขียนเพื่อนำ input ที่ได้คำนวณตามหน่วยที่ต้องการจะให้แปลงและทำการ print ออกมาเป็นแบบทศนิยม 2 ตำแหน่งโดยการใ้ช้ f string
```
