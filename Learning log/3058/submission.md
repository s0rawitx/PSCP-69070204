...
```text
โจทย์ให้หาว่าถ้าจะต่อสะพานให้ได้ goal นิ้วต้องใช้ brick ก้อนเล็กกี่ก้อนถ้าใช้ brick ก้อนใหญ่ต่อไปแล้วส่วนหนึ่ง
Input:
โปรแกรมรับจำนวนเต็มบวกจำนวน brick เล็ก brick ใหญ่ และ goal

Output:
โปรแกรมควรพิมพ์จำนวน brick ก้อนเล็กที่ต้องใช้

Constraints:
Output ถ้า brick ไม่พอต้องเป็น -1
```
...
```text
Step 1: รับค่า brick เล็กกับใหญ่ และ goal
Step 2: เขียน loop เช็คว่าต้องใช้ brick ใหญ่กี่ก้อน
Step 3: เขียน loop เช็คว่ามี brick เล็กกี่ก้อน
Step 4: เขียน if statement ในการเช็คว่า brick เล็กพอมั้ยถ้าพอก็ให้ print brick เล็ก ถ้าไม่ก็ print -1
```
...
```text
วิธีสุดท้ายของฉันคือ
1.รับค่าทั้งหมดมาก่อน
2.หาว่า brick ใหญ่ต้องใช้กี่ก้อนด้วยการใช้ // 
3.หาว่า brick ที่มีอยู่พอมั้ยสำหรับการสร้างโดยใช้ min 
4.หาว่าเหลิออยู่อีกกี่นิ้วถึงจะสร้างถึง goal ด้วยการเอา goal มาลบกับ brick ใหญ่
5.เขียน if statement มาเช็คว่า remain เหลือน้อยกว่าหรือเท่ากับ brick เล็กมั้ยเพิ้อเช็คว่า brick เล็กพอรึป่าว ถ้าไม่พอก็จะ print -1 แต่ถ้าพอก็จะ print จำนวน brick เล็กออกมา
```
...
```text
ทดสอบ brick เล็กมีพอที่จะใช้สร้าง
```
