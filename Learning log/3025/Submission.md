...
```text
โจทย์ให้หาว่า input เดือนและวันที่ให้มาจะเป็นฤดูอะไรตามที่โจทย์กำหนด

Input:
โปรแกรมรับ เดือน กับ วันมาซึ่งเป็นจำนวนเต็ม

Output:
โปรแกรมควรพิมพ์ ฤดูกาลของเดือนและวันที่ input มา

Constraints:
โจทย์กำหนดมาว่า ตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว โดยเปลี่ยนจากฤดูหนาว (winter) เป็นฤดูใบไม้ผลิ (spring) เปลี่ยนจากฤดูใบไม้ผลิ (spring) เป็นฤดูร้อน (summer) เปลี่ยนจากฤดูร้อน (summer) เป็นฤดูใบไม้ร่วง (fall) และเปลี่ยนจากฤดูใบไม้ร่วง (fall) เป็นฤดูหนาว (winter) ฉันควรพิจารณาการเขียน if statement ให้ตรงตามที่โจทย์กำหนด
```
...
Step 2:เขียน if statement ให้แต่ละฤดูตามที่โจทย์กำหนด
Step 3:เขียน if Statement ซ้อนข้างในอีกทีเพื่อที่จะได้เลื่อนฤดูให้ถูกตามที่โจทย์กำหนด
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้การเขียน if ซ้อนกันเพื่อดัก "หลังจากวันที่ 21 และเดือนที่ 3 หารลงตัว" ที่โจทย์ได้กำหนดไว้เพื่อใช้เลื่อนฤดูไปตามที่โจทย์ต้องการ
```
...
```text
ก่อนวันที่ 21 เดือนที่ 3 หารไม่ลงตัว
```
...
```text
ก่อนวันที่ 21 เดือนที่ 3 หารลงตัว
```
