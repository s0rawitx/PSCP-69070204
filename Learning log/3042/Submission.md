...
```text
โจทย์ให้รับ input เป็นเลขๆหนึ่ง แล้วให้หาว่าตั้งแต่ 0 ถึง เลขนั้น มีตัวไหนหาร 10 ลงตัวบ้าง

Input:
โปรแกรมรับจำนวนเต็มบวก 

Output:
โปรแกรมควรเลขทั้งหมดที่ 10 หารลงตัว

Constraints:
Output ที่โจทย์บอกเป็น N ถึง 0 ฉันควรพิจารณากัน print คำตอบออกมาให้ถูกต้องตามที่โจทย์กำหนด
```
...
Step 4:เขียน if statement ใน loop ว่าถ้าตัวเลขนี้หาร 10 ลงตัวให้เอาตัวเลขนั้นไปเก็บใน list
Step 5:ใช้ .reverse() เพื่อเรียงคำตอบให้ตรงตามโจทย์ต้องการ
Step 6:print คำตอบ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ .reverse() เพื่อเรียงคำตอบใน list ให้ตรงตามโจทย์และ ใช้ print(*m) เพื่อ print ของใน list ออกมาทั้งหมดโดยไม่มีวงเล็บ [] 
```
