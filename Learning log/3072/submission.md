...
```text
โจทย์ให้หาว่ามีสระกี่ตัวใน string ที่ให้มา

Input:
โปรแกรมรับ string (มีสระ)

Output:
โปรแกรมควรพิมพ์จำนวนสระใน string 

Constraints:
input เป็น string ฉันควรพิจารณาตัวพิมพ์ใหญ่ด้วย
```
...
```text
Step 1:รับ string มาและใช้ .lower() เพื่อบังคับให้เป็นพิมพ์เล็ก
Step 2:เขียนตัวแปร a,e,i,o,u มาเพื่อเก็บจำนวนสระ
Step 3:เขียน loop มาเช็คตัวอักษรทีละตัวใน string ถ้ามีสระให้บวกเข้าไปในตัวแปรสระนั้นๆ
Step 4:เขียน if statement มาพิมพ์ว่ามีสระตัวไหนบ้างและมีกี่ตัว
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ for loop เพื่อเช็คตัวอักษรแต่ละตัวใน string และเขียน if statement มาเพื่อเช็คว่าต้อง print ตัวไหนบ้าง
```
