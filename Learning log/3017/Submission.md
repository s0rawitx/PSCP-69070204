...
```text
โจทย์ให้คิดราคาอาหารหลังจากรวมค่า Service Charge และ Vat โดยที่ Service Charge จะมีขั้นต่ำอยู่ 50 บาทและจะคิดไม่เกิน 1000

Input:
โปรแกรมรับจำนวนค่าอาหารของลูกค้า

Output:
โปรแกรมควรพิมพ์ ราคาหลังจากคิด Service Charge และ Vat แล้ว

Constraints:
input เป็นราคาอาหารของลูกค้าอาจจะเป็นเลขทศนิยมได้
```
...
```text
Step 1: รับค่าราคาอาหาร
Step 2: คิดหาค่า Service Charge 
Step 3: ถ้า Service Charge น้อยกว่า 50 ให้ปรับเป็น 50 บาท
Step 4: ถ้า Service Charge มากกว่า 1000 ให้ปรับเป็น 1000 บาท
Step 5:นำค่า Service Charge มาบวกกับราคาอาหาร
Step 6:นำ Service Charge มาบวกกับค่าอาหาร
Step 7:นำค่าอาหารที่รวมกับ Service Charge แล้วไปคิดหาค่า Vat
Step 8:นำ Vat มาคิดหาราคาสุดท้าย
Step 9:Print ราคาสุดท้ายโดยทำให้เป็นเลขทศนิยม 2 หลัก
```
...
```text
เหมือนกับแผนแรก ฉันใช้คณิตศาสตร์ในการคิดหาราคาที่รวมทั้ง Vat และ Service Charge แล้ว และใช้ F string เพื่อ print คำตอบแบบเลขทศนิยม 2 หลัก
```
