...
```text
ให้เขียน if else มารับ input แล้วก็เขียนเงื่อนไขจามโจทย์
```
...
```text
Step 1:รับ input มา 2 ตัว
Step 2:เขียน if else
```
...
```text
เขียนตัวแปรมารับค่า 2 ค่า เขียน list แม่สีมาเพื่อกัน case ที่เป็นสีนอกแม่สีผสมกัน เขียน if else ตามโจทย์กำหนด
```
...
```text
เป็น test case ที่อยู่ใน if else แต่ไม่ใช่แม่สี
```
...
```text
ตาม sample testcase แต่สลับลำดับสี
```
